...
A zero-input, always-live, honestly-degrading, agent-driven observatory — plus a reusable weekly-report artifact for a team's sharing channel. Unpublished at time of writing (publish requires separate authorization).
